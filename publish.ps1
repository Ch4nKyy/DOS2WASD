...
Copy-Item $PSScriptRoot\extern\SDL2\SDL2*.dll $PSScriptRoot\package\bin\
Copy-Item $PSScriptRoot\extern\NativeModLoader\*.dll $PSScriptRoot\package\bin\
...
& "C:\Program Files\7-Zip\7z.exe" a -tzip $PSScriptRoot\package\DOS2WASD.zip $PSScriptRoot\package\bin
Remove-Item $PSScriptRoot\package\bin -Force -Recurse  -ErrorAction:SilentlyContinue | Out-Null
